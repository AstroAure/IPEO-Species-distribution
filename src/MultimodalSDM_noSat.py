...
class multimodal_SDM(nn.Module): #heritates from class nn.Module
    ...
    def __init__(self, dim_NN_env=128, dim_NN_sat=0, dim_NN_timeseries=64): #dimension of output of neural networks
    ...
    def forward (self, x):
        ...
        combined = torch.cat((NN_env_out, NN_time_series_out), dim=1)
