...
class multimodal_SDM(nn.Module): #heritates from class nn.Module
    ...
    def __init__(self, dim_NN_env=0, dim_NN_sat=0, dim_NN_timeseries=64): #dimension of output of neural networks
